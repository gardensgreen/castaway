...
def seed_boats():
    ...
    seed_boat10 = Boat(boat_type="Center Console",
                       total_occupancy=8, total_bedrooms=1, total_bathrooms=1, length=30, address="801 Brickell Bay Dr", summary="Center Console 6 People", has_tv=False, has_kitchen=True, has_air_con=False, has_internet=False, has_heating=False, price=2500, latitude=25.799950, longitude=-80.189000, owner_id=2,)
